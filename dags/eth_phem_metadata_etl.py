...
with DAG(
    dag_id='Ethiopia-PHEM-Metadata-ETL',
    default_args=default_args,
    description='Ethiopia PHEM DHIS2 Metadata Pipeline',
    schedule=None, 
    start_date=datetime(2025, 1, 1),
    max_active_runs=1,
    catchup=False,
    tags=['ETHIOPIA', 'DHIS2', 'PHEM', 'Metadata']
) as dag:
    ...
    build_att_dim_task = PythonOperator(
        ...
        op_kwargs={"POSTGRES_CONN_ID": "PG-ETH-DW", "STAGING_SCHEMA_NAME": "stg_phem", "DATA_SOURCE": "phem"}
    )
